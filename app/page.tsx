...
const discoveries = [
  ...
  { title: "Numeroloji", subtitle: "Sayıların sana ne söylüyor?", href: "/fal/numeroloji", image: "/fortune/numerology-number.jpg" },
];
...
const drawerItems = [
  ...
  ["Rüya Yorumu", "/fal/ruya", Moon],
  ["Numeroloji", "/fal/numeroloji", Star],
  ["Falcıya Sor", "/fal/sor", MessageCircle],
    ...
    <main className="min-h-screen overflow-x-hidden bg-[#070714] pb-[78px] text-white selection:bg-[#e7bd68] selection:text-[#160f1b]">
      ...
      <header className="sticky top-0 z-40 border-b border-white/[.06] bg-[#080817]/92 backdrop-blur-xl">
        <div className="mx-auto flex h-[56px] max-w-[1024px] items-center justify-between px-3 sm:h-[64px] sm:px-5">
          ...
          <Link href="/" className="flex items-center gap-2"><div className="grid h-8 w-8 place-items-center rounded-full border border-[#f0cf80]/30 bg-[#f0cf80]/10 sm:h-9 sm:w-9"><Moon className="h-4 w-4 fill-[#f6d98f] text-[#f6d98f] sm:h-[18px] sm:w-[18px]" /></div><div className="leading-none"><div className="font-serif text-[16px] font-bold tracking-tight text-[#f6dda2] sm:text-[18px]">Fal Köşesi</div><div className="mt-1 text-[7px] uppercase tracking-[.22em] text-[#aaa1bd] sm:text-[8px]">Kaderini keşfet</div></div></Link>
          <div className="flex items-center gap-1.5 sm:gap-2"><Link href="/kredi" className="inline-flex items-center gap-1.5 rounded-full border border-amber-300/20 bg-amber-300/10 px-2.5 py-1.5 text-[9px] font-black text-amber-100 sm:px-3 sm:text-[10px]"><Coins className="h-3.5 w-3.5" /> {credits === null ? "—" : credits}</Link><Link href="/bildirimler" className="relative grid h-9 w-9 place-items-center rounded-xl border border-white/10 bg-white/[.035] text-[#f5d78e] sm:h-10 sm:w-10" aria-label="Bildirimler"><Bell className="h-[18px] w-[18px]" /><span className="absolute right-2 top-2 h-1.5 w-1.5 rounded-full bg-[#f2b84b] shadow-[0_0_8px_#f2b84b]" /></Link><Link href="/profil" className="flex items-center gap-1.5 rounded-full border border-[#f0cf80]/15 bg-white/[.035] py-1 pl-1 pr-2 sm:gap-2 sm:py-1.5 sm:pl-1.5 sm:pr-3"><div className="grid h-7 w-7 place-items-center rounded-full bg-gradient-to-br from-[#f4d998] to-[#93602f] text-[#1a1020] sm:h-8 sm:w-8"><UserRound className="h-3.5 w-3.5 sm:h-4 sm:w-4" /></div><span className="max-w-[58px] truncate text-[10px] font-semibold text-[#eee5d5] sm:max-w-[80px] sm:text-xs">{firstName}</span></Link></div>
        </div>
      </header>

      <div className="mx-auto max-w-[1024px] px-3 sm:px-5">
        <section className="relative mt-2.5 overflow-hidden rounded-[20px] border border-[#d7b56d]/15 shadow-[0_18px_55px_rgba(0,0,0,.38)] sm:mt-4 sm:rounded-[28px]"><Image src="/fortune/coffee-reading.jpg" alt="Fal Köşesi mistik kahve falı" fill priority sizes="(max-width: 768px) 100vw, 1024px" className="object-cover object-center" /><div className="absolute inset-0 bg-gradient-to-r from-[#090918]/96 via-[#0b0919]/74 to-[#0b0919]/18" /><div className="relative min-h-[220px] px-4 py-6 sm:min-h-[300px] sm:px-8 sm:py-9 md:min-h-[330px] md:px-10"><div className="max-w-[510px]"><div className="inline-flex items-center gap-1.5 rounded-full border border-[#f5d88e]/20 bg-black/20 px-2.5 py-1 text-[8px] font-semibold uppercase tracking-[.20em] text-[#f5d88e] backdrop-blur-md sm:px-3 sm:py-1.5 sm:text-[9px]"><Sparkles className="h-3 w-3" /> Sana özel fal köşen</div><h1 className="mt-3 font-serif text-[27px] font-bold leading-none tracking-[-.035em] text-white sm:mt-4 sm:text-[38px] md:text-[44px]">Merhaba {firstName} <span className="text-[#f5d78e]">✦</span></h1><p className="mt-2 text-[12px] leading-5 text-[#d9d1e1] sm:mt-3 sm:text-base sm:leading-6">Bugün senin için neler söylüyor?</p><p className="mt-1 font-serif text-[11px] italic text-[#c8b9d6] sm:mt-2 sm:text-sm">“Her fincan, yeni bir hikâye anlatır…”</p></div></div></section>
