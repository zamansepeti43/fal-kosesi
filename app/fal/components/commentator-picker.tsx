...
function characterAvatar(id: string) { return `/fortune/avatars/${AVATAR_BY_ID[id] ?? "tarotella-reference.jpg"}?v=8`; }
function characterFallback(id: string) { return `/fortune/avatars/${AVATAR_FALLBACK_BY_ID[id] ?? "tarotella.svg"}?v=8`; }
