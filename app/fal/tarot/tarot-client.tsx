      ...
      <div className="mx-auto max-w-5xl">
        ...
        <section className="overflow-hidden rounded-[30px] border border-amber-200/15 bg-[radial-gradient(circle_at_80%_0%,rgba(245,158,11,.16),transparent_35%),rgba(17,12,29,.95)] shadow-2xl">
          <div className="relative h-[190px] sm:h-[270px]">
            ...
            <div className="absolute bottom-5 left-5 right-5 sm:left-8 sm:right-8"><p className="text-[9px] font-bold uppercase tracking-[.3em] text-amber-200">22 Büyük Arkana • Kişisel açılım</p><h1 className="mt-1 font-serif text-3xl font-bold sm:text-5xl">Tarot Falı</h1><p className="mt-1 max-w-2xl text-xs leading-5 text-slate-300 sm:text-sm">Sorunu belirle, açılımını seç ve kartları kendi sezginle çek. Her seçim ayrı bir aşamada açılır; sonrasında kartların birlikte anlattığı hikâyeyi oku.</p></div>
          </div>
