...
const relationshipOptions = [
  ["single", "Bekârım", "❤️"], ["relationship", "Bir ilişkim var", "💞"], ["married", "Evliyim", "💍"],
  ["separated", "Ayrılık sürecindeyim", "💔"], ["complicated", "Karmaşık", "🤍"], ["prefer_not", "Belirtmek istemiyorum", "🙈"],
];

const workOptions = [
  ["employed", "Çalışıyorum", "💼"], ["student", "Öğrenciyim", "🎓"], ["business", "Kendi işimi yapıyorum", "🚀"],
  ["job_search", "İş arıyorum", "🔎"], ["not_working", "Çalışmıyorum", "🏠"], ["retired", "Emekliyim", "🌿"], ["prefer_not", "Belirtmek istemiyorum", "🤍"],
];

const focusOptions = [
  ["love", "Aşk", "❤️"], ["money", "Para", "💰"], ["career", "Kariyer", "💼"], ["family", "Aile", "🏡"],
  ["future", "Gelecek", "✨"], ["self", "Kendim", "🪞"], ["general", "Genel", "🔮"],
];
